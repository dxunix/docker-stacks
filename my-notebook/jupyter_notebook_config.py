...
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$W0AnP9qlJ+eFS7GTaz1XgQ$M2T5aODssW6rHLFrvi0GNA'
...
#  Choices: any of ['sha3_384', 'sha3_512', 'blake2b', 'sha384', 'sha3_256', 'sha256', 'md5', 'sha224', 'sha3_224', 'sha1', 'blake2s', 'sha512']
#  Default: 'sha256'
